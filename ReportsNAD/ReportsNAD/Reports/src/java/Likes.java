...
public class Likes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Likes</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            Statement st= co.createStatement();
               ...
               ResultSet rs=st.executeQuery("select * from likes");
               
               out.println("<a href='/Reports/customer'>View Customers</a>");
               out.println("<br><a href='/Reports/Saveuser'>Log out</a>");
               
               out.println("<h1>Product Likes</h1>");
