    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            Statement st= co.createStatement();
               ...
               out.println("<a href='/Reports/Saveuser'>Log out</a>");
               
                out.println("<h1> Production Capacity</h1>");
            ...
            while(rs.next()){
                out.println("<tr>"
                        + "<td>"+rs.getString("longterm")+"</td>"
                        + "<td>"+rs.getString("midterm")+"</td>"        
                         + "<td>"+rs.getString("shortterm")+"</td>"       
                         + "<td>"+rs.getString("productiondate")+"</td>"       
                        + "</tr>");
            }
            out.println("</table>");
