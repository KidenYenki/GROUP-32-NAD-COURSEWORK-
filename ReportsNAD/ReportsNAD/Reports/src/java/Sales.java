    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            Statement st= co.createStatement();
               ...
               out.println("<a href='/Reports/Editstaff'>View Staff Details</a>");
               
               out.println("<br><a href='/Reports/Saveuser'>Log out</a>");
               
               out.println("<br><a href='/Reports/charts.jsp'>View Chart</a>");
               
                out.println("<h1> Sales </h1>");
            ...
            while(rs.next()){
                out.println("<tr>"
                        + "<td>"+rs.getString("customersname")+"</td>"
